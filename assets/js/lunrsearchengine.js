...
function lunr_search(term) {
    ...
    if(term) {
        document.getElementById('lunrsearchresults').innerHTML = "<p>Resultados de busca para '" + term + "'</p>" + document.getElementById('lunrsearchresults').innerHTML;
...
function lunr_search(term) {
    ...
    if(term) {
        document.getElementById('modtit').innerHTML = "<h5 class='modal-title'>Resultados encontrados para '" + term + "'</h5>" + document.getElementById('modtit').innerHTML;
        //put results on the screen.
        var results = idx.search(term);
        if(results.length>0){
            //console.log(idx.search(term));
            ...
            document.querySelectorAll('#lunrsearchresults ul')[0].innerHTML = "<li class='lunrsearchresult'>Desculpa, nenhum resultado encontrado. Feche e tente buscar outra coisa!</li>";
        }
    }
    return false;
}
